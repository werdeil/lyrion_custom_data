...
TRANSLATIONS = {
    "fr": {
        ...
        "lyrics_mode_once_hint": "Chercher pour ce morceau uniquement (synchro si disponible)",
        "lyrics_mode_auto_hint": "Chercher automatiquement pour chaque morceau (synchro si disponible)",
        "searching": "Recherche…",
    ...
    "en": {
        ...
        "lyrics_mode_once_hint": "Search for this track only (synced when available)",
        "lyrics_mode_auto_hint": "Search automatically for every track (synced when available)",
        "searching": "Searching…",
